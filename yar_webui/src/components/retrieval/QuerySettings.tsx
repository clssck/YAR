      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            title={title}
          >
            <RotateCcw className="text-muted-foreground hover:text-foreground h-3 w-3" />
          </button>
        </TooltipTrigger>
      ...
      <CardContent className="m-0 flex grow flex-col p-0 text-xs">
        <div className="relative size-full">
          <div className="absolute inset-0 flex flex-col gap-1 overflow-auto px-2 pr-2 pb-2">
            ...
            <CollapsibleSection
              title={t('retrievePanel.querySettings.sections.retrieval', 'Retrieval')}
              defaultOpen={true}
            >
              <div className="flex flex-col gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <label htmlFor="query_mode_select" className="ml-1 cursor-help text-xs">
                ...
                <div className="flex items-center gap-1">
                  ...
                  >
                    <SelectTrigger
                      ...
                      className="hover:bg-primary/5 h-8 flex-1 cursor-pointer text-left focus:ring-0 focus:ring-offset-0 focus:outline-0 active:right-0 [&>span]:line-clamp-1 [&>span]:break-all"
                    >
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <label htmlFor="top_k" className="ml-1 cursor-help text-xs">
                ...
                <div className="flex items-center gap-1">
                  <Input
                    ...
                    className="h-8 flex-1 pr-2 [-moz-appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                  />
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <label htmlFor="chunk_top_k" className="ml-1 cursor-help text-xs">
            ...
            <CollapsibleSection
              title={t('retrievePanel.querySettings.sections.tokenBudget', 'Token Budget')}
              defaultOpen={false}
            >
              <div className="flex flex-col gap-2">
                {/* Max Entity Tokens */}
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <label htmlFor="max_entity_tokens" className="ml-1 cursor-help text-xs">
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <label htmlFor="max_relation_tokens" className="ml-1 cursor-help text-xs">
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <label htmlFor="max_total_tokens" className="ml-1 cursor-help text-xs">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <label htmlFor="stream" className="ml-1 flex-1 cursor-help text-xs">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <label
                          ...
                          className="ml-1 flex-1 cursor-help text-xs"
                        >
                          {t(
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleChange('show_references_section', checked)}
                  />
                </div>
            ...
            {/* Advanced Section */}
            <CollapsibleSection
              title={t('retrievePanel.querySettings.sections.advanced', 'Advanced')}
              defaultOpen={false}
            >
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <label
                          ...
                          className={`ml-1 flex-1 cursor-help text-xs ${!isRerankerAvailable ? 'opacity-50' : ''}`}
                        >
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <label htmlFor="user_prompt" className="ml-1 cursor-help text-xs">
