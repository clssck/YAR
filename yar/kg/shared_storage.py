...
from yar.constants import NS_ORPHAN_CONNECTION_STATUS, NS_PIPELINE_STATUS
...
def direct_log(message, enable_output: bool = True, level: str = 'DEBUG'):
    ...
    # Get the current logger level from the yar logger
    try:
        from yar.utils import logger

        current_level = logger.getEffectiveLevel()
    except ImportError:
        # Fallback if yar.utils is not available
