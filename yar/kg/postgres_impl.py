...
class PostgreSQLDB:
    ...
    async def validate_vector_dimensions(self) -> None:
        ...
        vector_tables = [
            ...
            ('yar_vdb_relation', 'content_vector'),
        ]
    ...
    async def _migrate_llm_cache_schema(self):
        ...
        try:
            ...
            WHERE table_name = 'yar_llm_cache'
    ...
    async def _migrate_doc_chunks_to_vdb_chunks(self):
        ...
        try:
            ...
            WHERE table_name = 'yar_doc_chunks' AND column_name = 'content_vector'
            """
    ...
    async def _migrate_doc_status_add_chunks_list(self):
        ...
        try:
            ...
            SELECT column_name
            FROM information_schema.columns
            WHERE table_name = 'yar_doc_status'
    ...
    async def _migrate_text_chunks_add_llm_cache_list(self):
        ...
        try:
            ...
            SELECT column_name
            FROM information_schema.columns
            WHERE table_name = 'yar_doc_chunks'
    ...
    async def _migrate_doc_status_add_track_id(self):
        ...
        try:
            ...
            SELECT indexname
            FROM pg_indexes
            WHERE tablename = 'yar_doc_status'
            AND indexname = 'idx_yar_doc_status_track_id'
            """
    ...
    async def _migrate_entity_aliases_add_llm_columns(self):
        ...
        for col in columns_to_add:
            try:
                ...
                SELECT column_name
                FROM information_schema.columns
                WHERE table_name = 'yar_entity_aliases'
                AND column_name = $1
                """
    ...
    async def _migrate_entity_aliases_schema(self):
        ...
        index_name = 'idx_yar_entity_aliases_canonical'
        check_index_sql = """
        SELECT indexname
        FROM pg_indexes
        WHERE tablename = $1
