...
def main():
    ...
    from yar.api.config import initialize_config
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from yar.api import gunicorn_config
        ...
        def load(self):
            ...
            from yar.api.yar_server import get_application
