...
Usage:
    python -m yar.tools.clean_llm_query_cache
    # or
    python yar/tools/clean_llm_query_cache.py
...
from yar.utils import setup_logger

# Load environment variables
load_dotenv(dotenv_path='.env', override=False)

# Setup logger
setup_logger('yar', level='INFO')
...
class CleanupTool:
    ...
    def get_storage_class(self, storage_name: str):
        ...
        """
        if storage_name == 'PGKVStorage':
            from yar.kg.postgres_impl import PGKVStorage
    ...
    async def count_query_caches_pg(self, storage) -> dict[str, dict[str, int]]:
        ...
        """
        from yar.kg.postgres_impl import namespace_to_table_name
