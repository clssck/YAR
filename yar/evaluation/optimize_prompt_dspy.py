...
The optimized prompt can then be copied to yar/prompt.py.
...
def format_as_yar_prompt(optimized_prompt: str) -> str:
    """Format the optimized prompt for use in yar/prompt.py."""
    template = '''"""
RAG Response Prompt - Optimized by DSPy
========================================

Copy this to yar/prompt.py as PROMPTS['rag_response']
"""
...
async def main():
    ...
    if args.export_prompt:
        formatted = format_as_yar_prompt(optimized_prompt)
