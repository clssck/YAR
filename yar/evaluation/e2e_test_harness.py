...
Usage:
    ...
    python yar/evaluation/e2e_test_harness.py --skip-download
...
class E2ETestHarness:
    ...
    async def download_papers(self) -> list[str]:
        ...
        from yar.evaluation.download_arxiv import download_papers
    ...
    async def generate_dataset(self) -> Path:
        ...
        from yar.evaluation.generate_arxiv_dataset import generate_dataset
...
Examples:
  ...
  # Use existing dataset
  python yar/evaluation/e2e_test_harness.py --dataset arxiv_dataset.json
        """,
    )
