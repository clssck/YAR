...
Usage:
    python yar/evaluation/compare_results.py baseline.json experiment.json
    python yar/evaluation/compare_results.py results_a.json results_b.json --output comparison.json
"""
...
Examples:
  ...
  python yar/evaluation/compare_results.py baseline.json experiment.json --output comparison.json

  # Compare with/without orphan connections
  python yar/evaluation/compare_results.py results_without_orphans.json results_with_orphans.json
        """,
    )
