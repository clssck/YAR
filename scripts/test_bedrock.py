...
Usage:
    ...
    uv run scripts/test_bedrock.py --configured-only # Test only tuna + shrimp
    ...
    models_to_test = [
        {
            ...
            'type': 'llm',
            'description': 'Claude Sonnet (legacy Bedrock helper)',
        },
        {
            'name': 'shrimp',
            'model_id': 'amazon.titan-embed-text-v2:0',
            'type': 'embedding',
            'description': 'Titan Embed Text v2 (legacy Bedrock helper)',
        },
    ]
...
def main():
    ...
    parser.add_argument('--configured-only', action='store_true', help='Test only YAR alias equivalents (tuna, shrimp)')
